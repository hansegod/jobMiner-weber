...
<div class="container">
    <ol class="breadcrumb">
        <li><a href="${CTX}/advertiser">招聘单位</a></li>
        <li class="active">编辑招聘单位</li>
    </ol>
    <div class="row">
        <div class="col-md-6">
            <form id="advertiserForm" class="form-horizontal">
                <div class="form-group">
                    <label for="advertiser_name" class="col-md-4 control-label">招聘单位名称：</label>
                    <div class="col-md-8">
